...
def main():
    ...
    parser.add_argument("--seq_depth", type=int, default=None)
    parser.add_argument(
    ...
    for i in range(args.pos, args.pos + (1 if args.seq_depth is None else args.seq_depth)):
        t = pick_position(sub_trees, slice(None), i)
